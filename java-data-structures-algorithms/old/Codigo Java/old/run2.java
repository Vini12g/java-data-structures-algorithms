...
public class run2 {
    public static void main(String[] args) {
        ...
        v1.remove(1);
        System.out.println("Vetor após remover dado da posição 1: " + v1);

        v1.adiciona(88.5);
        v1.adiciona("Lucas");

        System.out.println("Vetor após adicionar 2 novos dados: " + v1);
        ...
        System.out.println("Vetor após adicionar um dado na posição 1: " + v1);

        System.out.println("Teste Contém:");
        System.out.println("Deve retornar True: " + v1.contem("Lucas"));
        System.out.println("Deve retornar False: " + v1.contem("Darius"));

        
        v1.adiciona(50, "Teste Final");
        System.out.println("Teste posição invalida: " + v1);
